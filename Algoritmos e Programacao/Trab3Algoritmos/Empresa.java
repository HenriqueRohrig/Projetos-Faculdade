public class Empresa {
  public static void main (String args[]) {
   ...
   while (i<2) {
     ...
     System.out.println("Quantidades de pessoas que responderam 'Não': "+b);
     System.out.println("Quantidade de pessoas do sexo Feminino que disseram 'Sim'"+c);
     System.out.println("Quantidade de pessoas do sexo Masculino que disseram 'Não'"+d);
     System.out.println("Número de pessoas pesquisadas: "+i);
  }
}
