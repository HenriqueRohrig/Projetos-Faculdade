//5) Uma empresa fez uma pesquisa com 10 pessoas para saber a aceitação de um produto
//lançado no mercado, para isso devemos ler o sexo e a resposta de cada pessoa pesquisada.
//No final informar:
//a. Quantas pessoas responderam SIM.
//b. Quantas pessoas responderam NÃO.
//c. Quantas pessoas do sexo feminino disseram SIM.
//d. Quantas pessoas do sexo masculino disseram NÂO.
...
public class Pesquisa {
  public static void main (String args[]) {
   ...
   System.out.println("Quantas pessoas responderam SIM:"+qa);
     System.out.println("Quantas pessoas responderam NÃO:"+qb);
     System.out.println("Quantas pessoas do sexo feminino disseram SIM:"+qc);
     System.out.println("Quantas pessoas do sexo masculino disseram NÂO:"+qd);
